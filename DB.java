...
public class DB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        db.execSQL("create table clientes(nombreHospital text, telefono text, correo text, encargado text, estado text, municipio text)");
    }
    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion){}

    public String guardar (String nombreHospital, String telefono, String correo, String encargado, String estado, String municipio){
        String mensaje="";
